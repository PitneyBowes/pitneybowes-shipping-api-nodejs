...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.AdditionalAddress();
  });
  ...
  describe('AdditionalAddress', function() {
    it('should create an instance of AdditionalAddress', function() {
      // uncomment below and update the code to test AdditionalAddress
      //var instane = new ShippingApi.AdditionalAddress();
      //expect(instance).to.be.a(ShippingApi.AdditionalAddress);
    });
