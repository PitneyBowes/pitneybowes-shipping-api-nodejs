...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.ParcelWeight();
  });
  ...
  describe('ParcelWeight', function() {
    it('should create an instance of ParcelWeight', function() {
      // uncomment below and update the code to test ParcelWeight
      //var instane = new ShippingApi.ParcelWeight();
      //expect(instance).to.be.a(ShippingApi.ParcelWeight);
    });
