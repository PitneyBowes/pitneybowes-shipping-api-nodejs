...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.CrossBorderQuotesRequestRates();
  });
  ...
  describe('CrossBorderQuotesRequestRates', function() {
    it('should create an instance of CrossBorderQuotesRequestRates', function() {
      // uncomment below and update the code to test CrossBorderQuotesRequestRates
      //var instane = new ShippingApi.CrossBorderQuotesRequestRates();
      //expect(instance).to.be.a(ShippingApi.CrossBorderQuotesRequestRates);
    });
