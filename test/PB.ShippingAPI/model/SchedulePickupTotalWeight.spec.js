...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.SchedulePickupTotalWeight();
  });
  ...
  describe('SchedulePickupTotalWeight', function() {
    it('should create an instance of SchedulePickupTotalWeight', function() {
      // uncomment below and update the code to test SchedulePickupTotalWeight
      //var instane = new ShippingApi.SchedulePickupTotalWeight();
      //expect(instance).to.be.a(ShippingApi.SchedulePickupTotalWeight);
    });
