...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.PageRealTransactionDetailReport();
  });
  ...
  describe('PageRealTransactionDetailReport', function() {
    it('should create an instance of PageRealTransactionDetailReport', function() {
      // uncomment below and update the code to test PageRealTransactionDetailReport
      //var instane = new ShippingApi.PageRealTransactionDetailReport();
      //expect(instance).to.be.a(ShippingApi.PageRealTransactionDetailReport);
    });
