...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.CrossBorderQuotesErrorsErrorsErrors();
  });
  ...
  describe('CrossBorderQuotesErrorsErrorsErrors', function() {
    it('should create an instance of CrossBorderQuotesErrorsErrorsErrors', function() {
      // uncomment below and update the code to test CrossBorderQuotesErrorsErrorsErrors
      //var instane = new ShippingApi.CrossBorderQuotesErrorsErrorsErrors();
      //expect(instance).to.be.a(ShippingApi.CrossBorderQuotesErrorsErrorsErrors);
    });
