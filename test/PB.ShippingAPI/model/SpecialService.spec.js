...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.SpecialService();
  });
  ...
  describe('SpecialService', function() {
    it('should create an instance of SpecialService', function() {
      // uncomment below and update the code to test SpecialService
      //var instane = new ShippingApi.SpecialService();
      //expect(instance).to.be.a(ShippingApi.SpecialService);
    });
