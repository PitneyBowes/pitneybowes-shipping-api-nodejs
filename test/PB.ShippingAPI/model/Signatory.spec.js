...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.Signatory();
  });
  ...
  describe('Signatory', function() {
    it('should create an instance of Signatory', function() {
      // uncomment below and update the code to test Signatory
      //var instane = new ShippingApi.Signatory();
      //expect(instance).to.be.a(ShippingApi.Signatory);
    });
