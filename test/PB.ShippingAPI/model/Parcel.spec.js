...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.Parcel();
  });
  ...
  describe('Parcel', function() {
    it('should create an instance of Parcel', function() {
      // uncomment below and update the code to test Parcel
      //var instane = new ShippingApi.Parcel();
      //expect(instance).to.be.a(ShippingApi.Parcel);
    });
