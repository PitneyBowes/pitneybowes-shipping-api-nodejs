...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.AddTrackingEvents();
  });
  ...
  describe('AddTrackingEvents', function() {
    it('should create an instance of AddTrackingEvents', function() {
      // uncomment below and update the code to test AddTrackingEvents
      //var instane = new ShippingApi.AddTrackingEvents();
      //expect(instance).to.be.a(ShippingApi.AddTrackingEvents);
    });
