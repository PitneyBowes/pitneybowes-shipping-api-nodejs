...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShippingApi.CrossBorderQuotesResponseTotalRates();
  });
  ...
  describe('CrossBorderQuotesResponseTotalRates', function() {
    it('should create an instance of CrossBorderQuotesResponseTotalRates', function() {
      // uncomment below and update the code to test CrossBorderQuotesResponseTotalRates
      //var instane = new ShippingApi.CrossBorderQuotesResponseTotalRates();
      //expect(instance).to.be.a(ShippingApi.CrossBorderQuotesResponseTotalRates);
    });
